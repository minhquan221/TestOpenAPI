...
namespace TestAPIConnect.Common
{
    public class APIHelper
    {
        ...
        public static HttpWebRequest builHeader(HttpWebRequest client, List<string[]> header = null, string authen = "", string Id = "", string Secret = "", string strprivatekey = "", string strcertificate = "", string strdata = "")
        {
            ...
            //var Signature = CommonCertificate.Current.SignPem(strdata, PrivateKey);
            ...
            //X-IBM-Client-Id: f9f601eac7bd8310360a79051abc333b
            //X-IBM-Secret-Id: 42b97a6246555a2b642a5522c2a9b720
        ...
        public static string RandomTransId()
        {
            ...
            //var intResult = rnd.Next(int.MinValue, int.MaxValue);
        ...
        public static string CallAPI2(ref int status, ref string Msg, ref object Err, string function, string method = WebRequestMethods.Http.Post, int offset = 0, string ContentType = "application/json", List<string[]> header = null, object parameters = null, string authen = "", string clientId = "", string clientSecret = "", string strprivatekey = "", string strcertificate = "")
        {
            status = -1;
            Msg = string.Empty;
            Err = null;
            ...
            catch (Exception ex)
            {
                status = 0;
                Msg = ex.ToString();
                Err = ConvertHelper.Current.ConvertError2(ex);
                return string.Empty;
            }
        }
        ...
        public static JsonResultData AccessToken<T>(ref int status, ref string Msg, ref object Err, LoginModel user) where T : new()
        {
            ...
            try
            {
                ...
                var postData = "scope=" + HttpUtility.UrlEncode("OCB");
